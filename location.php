...
<style>
  ...
  <body style="margin:0px; padding:0px;" onload="initMap()">
    <div>
        ...
        <input type="button" class="btn btn-warning onclick" id="searchButton" value="Search"/>
    </div>
    ...
    <script async defer
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDQ6xbp3l6djkhw7DuMCzVyNF95ruCte7A&callback=initMap">
    </script>
  </body>
</html>